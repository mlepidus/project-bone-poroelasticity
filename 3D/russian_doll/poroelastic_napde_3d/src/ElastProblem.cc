...
{  
   ...
   printf("Elastic problem created\n");
...
{
			scalar_type currentTime = M_time->time();
			...
			//M_BC.setOuterBoundaryInterpolationD("line_profiles/displacement1/real/d_real_" + LifeV::number2string(currentStep) + ".csv", degree); 
			M_BC.setOuterBoundaryInterpolationD("line_profiles/displacement1/approximated/disp_ideal_" + LifeV::number2string(currentStep) + ".csv", degree); 
